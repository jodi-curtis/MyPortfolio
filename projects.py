...
projects = [
    Project(
        ...
        images=['jazz_fanzz.jpg','jazz_fanzz2.jpg','jazz_fanzz3.jpg','jazz_fanzz4.jpg'],
    ...
    Project(
        ...
        images=['maths_playground.jpg', 'maths_playground2.jpg','maths_playground3.jpg','maths_playground4.jpg','maths_playground5.jpg'],
    ...
    Project(
        ...
        images=['recycling_assistant.jpg', 'recycling_assistant2.png', 'recycling_assistant3.png'],
        link='',
        languages=[5],
